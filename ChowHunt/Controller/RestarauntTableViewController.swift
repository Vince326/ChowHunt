...
//  ChowHunt
//
//  Created by Vincent Hunter on 2/5/23.
//
...
class RestaurantTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //Enables large title in navigation bar
        ...
        if let appearance = navigationController?.navigationBar.standardAppearance {
            ...
            //Set the font and color for the title text (large & small)
            if let customFont = UIFont(name: "Nunito-Bold", size: 45.0) {
                
                appearance.titleTextAttributes = [.foregroundColor : UIColor(named: "NavigationBarController")!]
                
                appearance.largeTitleTextAttributes = [.foregroundColor:UIColor(named:"NavigationBarController")! , .font: customFont]
            }
    ...
    func configureDataSouce () -> RestaurantDiffableDataSource {
        ...
        return dataSource as! RestaurantDiffableDataSource
    }
...
//    }
    ...
    var restarauntIsFavorites = Array(repeating: false, count: 21)
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deleteAction = UIContextualAction(style: .destructive, title: "Delete") { (action, sourceView, completionHandler) in
            ...
            //Calls completion handler to dismiss action button
        ...
        shareAction.image = UIImage(named: "square.and.arrow.up")
            
        //Configure both as swipe action
        let swipeConfiguration = UISwipeActionsConfiguration(actions: [deleteAction, shareAction])
        
        return swipeConfiguration
            }
    
    // MARK: - Leading swipe action function
    override func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        
        
        //Favorite Action
        let markFavoriteAction = UIContextualAction(style: .destructive, title: "") { (action, sourceView, completionHandler) in
        ...
        //Configure right swipe action
        markFavoriteAction.backgroundColor = UIColor.systemYellow
        markFavoriteAction.image = UIImage(systemName: self.restaurants[indexPath.row].isFavorite ? "heart.slash.fill" : "heart.fill")
        ...
        return swipeConfiguration
             ...
             */
             ...
             override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
                 if segue.identifier == "showRestaurantCell" {
